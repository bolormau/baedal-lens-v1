      ...
      if (isDemo) {
        ...
        const mockScanResult = {
          ...
          plasticItems: [
            ...
            { name: '플라스틱 수저 세트', quantity: 2, material: 'PS', co2: 10 },
          ],
          totalCo2: 70,
          lensComment: '치킨 배달에서 일회용 용기 2개와 비닐봉투가 사용되었네요. 다음에는 다회용기 가게를 이용해보는 건 어떨까요?',
          createdAt: new Date().toISOString(),
        };
        
        setCurrentScan(mockScanResult);
        router.push('/scan/result');
        return;
      }
      
      // Real mode: call Claude API for analysis
